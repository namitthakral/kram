...
// Note: Kram IDs are now auto-generated by database trigger
// No need to import or manually generate them
...
async function main() {
  console.log('')
  console.log('═══════════════════════════════════════════════════════════')
  console.log('🌱 Kram Database Seeding')
  console.log('═══════════════════════════════════════════════════════════')
  console.log('')
  ...
  const books = await createLibraryData(institution.id, librarianUser.id)
...
async function createInstitution() {
  return await prisma.institution.upsert({
    ...
    update: {},
    create: {
      code: 'EDU', // Institution code for Kram University
      name: 'Kram University',
      type: 'UNIVERSITY',
...
async function createUsers(
  ...
  const teacherUser = await prisma.user.upsert({
    where: { email: 'john.doe@kram.edu' },
    update: {},
    create: {
      firstName: 'John',
      lastName: 'Doe',
      name: 'Dr. John Doe',
      email: 'john.doe@kram.edu',
      phone: '+1-555-0002',
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    const studentUser = await prisma.user.upsert({
      where: { email: `student${i}@kram.edu` },
      update: {},
      create: {
        firstName: `Student`,
        lastName: `${i}`,
        name: `Student ${i}`,
        email: `student${i}@kram.edu`,
        phone: `+1-555-000${i + 2}`,
  ...
  const staffUser = await prisma.user.upsert({
    where: { email: 'staff@kram.edu' },
    update: {},
    create: {
      firstName: 'Support',
      lastName: 'Staff',
      name: 'Support Staff',
      email: 'staff@kram.edu',
      phone: '+1-555-0010',
  ...
  const librarianUser = await prisma.user.upsert({
    where: { email: 'librarian@kram.edu' },
    update: {},
    create: {
      firstName: 'Library',
      lastName: 'Manager',
      name: 'Library Manager',
      email: 'librarian@kram.edu',
      phone: '+1-555-0012',
  ...
  const accountantUser = await prisma.user.upsert({
    where: { email: 'accountant@kram.edu' },
    update: {},
    create: {
      firstName: 'Finance',
      lastName: 'Manager',
      name: 'Finance Manager',
      email: 'accountant@kram.edu',
      phone: '+1-555-0014',
...
function printSummary(studentCount: number, parentCount: number) {
  ...
  console.log('Staff: staff@kram.edu / staff123!')
  console.log('Librarian: librarian@kram.edu / librarian123!')
  console.log('Accountant: accountant@kram.edu / accountant123!')
  console.log('\n📊 Data Created:')
  console.log(
...
async function createPhase1TestData() {
  ...
  const teacher = await prisma.teacher.findFirst({
    where: { user: { email: 'john.doe@kram.edu' } },
    include: { user: true },
  })
