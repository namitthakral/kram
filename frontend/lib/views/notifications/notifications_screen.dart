            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.titleMedium?.copyWith(color: AppTheme.slate600),
                ),
              ],
            ),
          );
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      color:
          communication.isRead
              ? Colors.white
              : CustomAppColors.primary.withValues(alpha: 0.02),
      child: ExpansionTile(
        leading: Container(
        ...
        title: Text(
          ...
          style: TextStyle(
            fontWeight:
                communication.isRead ? FontWeight.normal : FontWeight.bold,
