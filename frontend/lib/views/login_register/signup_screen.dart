            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Sign Up Form
                  _buildSignUpForm(context, translate, provider, themeProvider),
        ...
        Selector<SignUpProvider, bool>(
          ...
          builder:
              (context, value, child) => CustomTextField(
                ...
                obscureText: !value,
                hintText: translate('confirm_password_hint'),
                suffixButtonIcon: ButtonIcon(
                  icon:
                      value
                          ? CustomImages.iconVisible
      ...
      Row(
        ...
        children: [
          ...
          CustomTextButton(
            ...
            onButtonPressed: () {
              context.read<OnboardingProvider>().setLogintype(LoginType.login);
