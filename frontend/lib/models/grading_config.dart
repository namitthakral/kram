...
class UpdateGradingConfigDto {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (attendanceWeight != null) {
      map['attendanceWeight'] = attendanceWeight;
    }
    if (assignmentWeight != null) {
      map['assignmentWeight'] = assignmentWeight;
    }
    if (examWeight != null) {
      map['examWeight'] = examWeight;
    }
    ...
    if (gradeAThreshold != null) {
      map['gradeAThreshold'] = gradeAThreshold;
    }
    if (gradeBPlusThreshold != null) {
      map['gradeBPlusThreshold'] = gradeBPlusThreshold;
    }
    if (gradeBThreshold != null) {
      map['gradeBThreshold'] = gradeBThreshold;
    }
    if (gradeCThreshold != null) {
      map['gradeCThreshold'] = gradeCThreshold;
    }
    if (gradeAPlusPoints != null) {
      map['gradeAPlusPoints'] = gradeAPlusPoints;
    }
    if (gradeAPoints != null) {
      map['gradeAPoints'] = gradeAPoints;
    }
    if (gradeBPlusPoints != null) {
      map['gradeBPlusPoints'] = gradeBPlusPoints;
    }
    if (gradeBPoints != null) {
      map['gradeBPoints'] = gradeBPoints;
    }
    if (gradeCPoints != null) {
      map['gradeCPoints'] = gradeCPoints;
    }
    if (gradeDPoints != null) {
      map['gradeDPoints'] = gradeDPoints;
    }
    if (atRiskAttendance != null) {
      map['atRiskAttendance'] = atRiskAttendance;
    }
    if (atRiskAssignment != null) {
      map['atRiskAssignment'] = atRiskAssignment;
    }
    if (atRiskExam != null) {
      map['atRiskExam'] = atRiskExam;
    }
    ...
    if (excellentExam != null) {
      map['excellentExam'] = excellentExam;
    }
    if (excellentGradePoints != null) {
      map['excellentGradePoints'] = excellentGradePoints;
    }
    if (goodAttendance != null) {
      map['goodAttendance'] = goodAttendance;
    }
    if (goodAssignment != null) {
      map['goodAssignment'] = goodAssignment;
    }
    if (goodExam != null) {
      map['goodExam'] = goodExam;
    }
    if (goodGradePoints != null) {
      map['goodGradePoints'] = goodGradePoints;
    }
    if (isActive != null) {
