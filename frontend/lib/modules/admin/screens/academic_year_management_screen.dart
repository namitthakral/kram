...
class _AcademicYearManagementScreenState
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      label: Text(
                        context.translate(
                          _isSchool ? 'add_term' : 'add_semester',
                        ),
                      ),
  ...
  Widget _buildSemesterTile(Semester semester) => Container(
    padding: const EdgeInsets.all(16),
    decoration: BoxDecoration(
      color: AppTheme.slate50,
      borderRadius: BorderRadius.circular(12),
  ...
  Widget _buildStatusToggle(Semester semester) => PopupMenuButton<String>(
  ...
  Future<void> _updateSemesterStatus(
    Semester semester,
    String newStatus,
  ) async {
