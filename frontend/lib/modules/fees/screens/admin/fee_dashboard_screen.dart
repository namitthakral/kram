...
class _FeeDashboardScreenState extends State<FeeDashboardScreen>
  ...
  Widget build(BuildContext context) {
    final institutionId = context.watch<LoginProvider>().currentUser?.institutionId;
      ...
      builder: (context, provider, _) {
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              _SummaryRow(
                  context.translate('total_payments'), summary.totalPayments.toString()),
              _SummaryRow(
                  context.translate('total_amount'), '₹${summary.totalAmount.toStringAsFixed(2)}'),
              const SizedBox(height: 16),
              Text(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: AppStyles.titleSmall.copyWith(fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
