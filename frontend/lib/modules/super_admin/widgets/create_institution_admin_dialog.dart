...
class _CreateInstitutionAdminDialogState
  ...
  Future<void> _searchUsers(String query) async {
    ...
    try {
      ...
      final response = await adminService.getAllUsers(search: query, limit: 10);
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      showCustomSnackbar(
        message: 'Admin ${_selectedUserUuid != null ? "assigned" : "created"} for ${widget.institutionName}',
              ...
              children: [
                ...
                if (_selectedUserUuid != null)
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.person, size: 16, color: AppTheme.blue500),
